...
export default function BestIndex() {
  const pages = getAllSEOPages().filter(p => p.category === 'best')
      ...
      <div className="bg-gradient-to-b from-gray-900 to-gray-950 border-b border-gray-800">
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-100 mb-4">
            Best Keto Coffee <span className="text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-orange-500">Top Picks</span>
          </h1>
          <p className="text-lg text-gray-400 max-w-2xl">
            Our expert picks for the best keto coffee products, ranked and reviewed for every need and budget.
          </p>
        </div>
      </div>
